...
from orcamento.core.services.utils.db_utils import case_insensitive_get

if TYPE_CHECKING:
    from orcamento.core.models import Expense, Transaction
...
def get_unconsolidated_transactions() -> Transaction.QuerySet:
    ...
    from orcamento.core.models import Transaction
...
def consolidate_transaction(
    ...
    """
    from orcamento.core.models import Category, Expense, SubCategory
