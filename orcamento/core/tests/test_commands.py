...
class TestImportarCommand:
    ...
    @patch("orcamento.core.management.commands.importar.shutil.move")
    @patch("orcamento.core.management.commands.importar.import_ofx")
    @patch("os.listdir")
...
class TestSugerirCommand:
    ...
    @patch(
        "orcamento.core.management.commands.sugerir.generate_suggestion_for_transaction"
    )
...
class TestConsolidarCommand:
    ...
    @patch("builtins.input")
    @patch("orcamento.core.management.commands.consolidar.consolidate_transaction")
