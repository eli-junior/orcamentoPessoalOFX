...
import pytest
from orcamento.core.models import Account, Transaction, Expense
from orcamento.core.services.import_ofx import import_ofx
...
@pytest.fixture
def mock_ofx_parser():
    with patch("orcamento.core.services.import_ofx.OfxParser") as mock:
        yield mock
