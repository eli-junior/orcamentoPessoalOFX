...
from orcamento.core import views
from orcamento.core.auth_forms import EmailLoginForm
...
urlpatterns = [
    ...
    path(
        "categorias/nova/", views.CategoryCreateView.as_view(), name="category_create"
    ),
    path(
    ...
    # Subcategorias
    path(
        "subcategorias/", views.SubCategoryListView.as_view(), name="subcategory_list"
    ),
    path(
        "subcategorias/nova/",
    ...
    path(
        "sugestoes/<int:pk>/aceitar/", views.suggestion_accept, name="suggestion_accept"
    ),
    path(
        "sugestoes/<int:pk>/rejeitar/",
        views.suggestion_reject,
        name="suggestion_reject",
    ),
    path(
        "api/pending-suggestions-count/",
        views.pending_suggestions_count,
        name="pending_suggestions_count",
    ),
    # Importação
